...
tibble(
  ...
  knitr::kable(format = "latex", booktabs = TRUE, digits = c(NA, 3,3,4))
```
\vfill
...
tibble(要因 = c("A", "e", " "),
  ...
  knitr::kable(format = "latex", booktabs = TRUE, escape=FALSE, caption=CAP)
```
...
# More examples on multiple comparisons
