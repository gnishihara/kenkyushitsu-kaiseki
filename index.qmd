...
[`r fontawesome::fa("r-project", height = "1.5em")`](https://cran.r-project.org/) はここ <https://cran.r-project.org/> からダウンロードできます。Windows ユーザは [Rtools43](https://cran.r-project.org/bin/windows/Rtools/rtools43/rtools.html) もインストールしましょう。ページ内の Rtools42 installer のリンクを探してね。
